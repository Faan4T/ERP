...
export class SidebarMenuComponent extends AppComponentBase implements OnInit {
    ...
    getMenuItems(): MenuItem[] {
        return [
            ...
            new MenuItem(this.l('Students'), '/app/students', 'fas fa-users','Pages.Students'),
            new MenuItem(this.l('TreeView'), '/app/tree-view', 'pi pi-list',null),
            new MenuItem(this.l('Courses'), '/app/courses', 'pi pi-book','Pages.Courses'),
            new MenuItem(this.l('Departments'), '/app/departments', 'pi pi-building','Pages.Departments'),
            new MenuItem(this.l('Teachers'), '/app/teachers', 'pi pi-users','Pages.Teachers'),
            new MenuItem(this.l('TeacherTreeView'), '/app/teacher-tree-view', 'pi pi-building',null),
