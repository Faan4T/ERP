...
{
    public abstract class ERPWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ERPWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ERPWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ERPDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ERPDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ERPDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ERPDbContext, Task<T>> func)
        {
            T result;
