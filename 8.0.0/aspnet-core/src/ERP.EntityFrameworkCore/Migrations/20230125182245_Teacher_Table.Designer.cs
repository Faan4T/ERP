...
namespace ERP.Migrations
{
    ...
    [Migration("20230125182245_Teacher_Table")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ERP.Courses.Course", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ERP.Departments.Department", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ERP.Students.Student", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ERP.StudentsWithCourses.StudentWithCourse", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ERP.TeacherWithCourses.TeacherWithCourse", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("TeacherWithCourses");
                });

            modelBuilder.Entity("ERP.Teachers.Teacher", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ERP.Students.Student", b =>
                {
                    b.HasOne("ERP.Departments.Department", "Departments")
                        .WithMany()
            ...
            modelBuilder.Entity("ERP.StudentsWithCourses.StudentWithCourse", b =>
                {
                    b.HasOne("ERP.Courses.Course", "Courses")
                        .WithMany()
                        .HasForeignKey("CourseId");

                    b.HasOne("ERP.Students.Student", "Students")
                        .WithMany()
            ...
            modelBuilder.Entity("ERP.TeacherWithCourses.TeacherWithCourse", b =>
                {
                    ...
                    b.HasOne("ERP.Teachers.Teacher", "Students")
                        .WithMany()
