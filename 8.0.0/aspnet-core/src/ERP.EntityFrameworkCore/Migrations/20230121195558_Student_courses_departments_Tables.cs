...
{
    /// <inheritdoc />
    public partial class StudentcoursesdepartmentsTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CoursesEnrolled_Students_StudentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CoursesEnrolled_CourseId",
                table: "CoursesEnrolled",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_CoursesEnrolled_StudentId",
                table: "CoursesEnrolled",
                column: "StudentId");
